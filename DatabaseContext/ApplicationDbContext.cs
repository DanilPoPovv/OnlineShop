    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().Property(p => p.Price).HasColumnType("decimal(18,2)")
                .HasDefaultValue(0);
            modelBuilder.Entity<Product>().ToTable(t => t.HasCheckConstraint("CK_Product_MaxValue", "[Price] <= 999999"));
            modelBuilder.Entity<Product>().ToTable(u => u.HasCheckConstraint("CK_Quantity_MaxValue", "[Quantity] < 10000"));
            ...
            modelBuilder.Entity<Shop>().HasOne(s => s.Manager).WithOne().HasForeignKey<User>(u => u.ShopId).OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity<User>().HasOne(u => u.Shop).WithOne().HasForeignKey<User>(u => u.ShopId);            
        }
    }
}
